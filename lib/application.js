...
AdaptBuilder.prototype.start = function() {
  ...
  this.once('modulesReady', function (app) {
    ...
    server.configure(function () {
      ...
      server.set('views', path.join(app.configuration.serverRoot, 'views'));
      ...
      server.use(express.static(path.join(app.configuration.serverRoot, 'build')));
